...
exh = nib.load(f"{PROJ_DIR}/data/heteromaps/macaque/space-fsLR_den-4k_hemi-L_desc-exh.func.gii").darrays[0].data[medmask]
inh = nib.load(f"{PROJ_DIR}/data/heteromaps/macaque/space-fsLR_den-4k_hemi-L_desc-inh.func.gii").darrays[0].data[medmask]
...
plot_surf(surf, unmask(exh_scaled, medmask), cmap="turbo", cbar=True, ax=axs[0])
plot_surf(surf, unmask(inh_scaled, medmask), cmap="turbo", cbar=True, ax=axs[1])
plot_surf(surf, unmask(eiratio, medmask), cmap="turbo", cbar=True, ax=axs[2])
